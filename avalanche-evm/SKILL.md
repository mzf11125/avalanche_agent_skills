...
name: avalanche-evm
description: >
  Subnet-EVM configuration, precompiles, genesis setup, Hardhat and Foundry
  integration for Avalanche L1s. Use this skill when answering questions about
  Subnet-EVM, custom precompiles, genesis.json, deploying contracts to Avalanche
  L1s, configuring EVM parameters, fee mechanisms, or setting up development
  tooling for Avalanche.
version: 0.1.0
